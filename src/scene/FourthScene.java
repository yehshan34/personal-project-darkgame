...
public class FourthScene extends Scene {
    ...
    public FourthScene(int playerNum){
    ...
    public void sceneBegin() {
        ...
        player = new Player(playerNum, 1088, 1984);
        glow = new Glow(1088, 1984, player);
        key = new Key(1088, 832);
...
//        player.setLastPosition(player.collider().centerX(), player.collider().centerY());
    ...
    public void mapInit() {
        floorArr = Map.genFloor("/Map03.bmp", "/Map03.txt", "floor0");
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_down"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_down_up"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_left"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_left_down"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_left_up"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_leftx3"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_right"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_right_down"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_right_left"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_right_up"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_rightx3"));
        floorArr.addAll(Map.genFloor("/Map03.bmp", "/Map03.txt", "floor_wall_up"));


        spikeArr.addAll(Map.genSpike("/Map03.bmp", "/Map03.txt", "spike0"));
        stairArr = Map.genStair("/Map03.bmp", "/Map03.txt", "stair0_up");
        wallArr = Map.genWall("/Map03.bmp", "/Map03.txt", "brownwall");
    ...
    public void playerDead(){
        if (deadDelay.count() && player.getState() != Player.PlayerState.ALIVE) {
            deathCount++;
            SceneController.getInstance().change(new TransitionScene(3, playerNum));
        }
    }
    ...
    public void stair(){
        stairArr.forEach(g -> {
            if (g.isCollisionCenter(player) && player.keyCondition()) {
                ...
                SceneController.getInstance().change(new TowerScene(3,playerNum));
            }
        });
    }
    public void monster(){
