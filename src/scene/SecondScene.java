...
//    private Lightning lightning;
    ...
    public SecondScene(int playerNum){
    ...
    public void sceneBegin() {
        ...
        player = new Player(playerNum, 1088, 2112);
        glow = new Glow(1088, 2112, player);
        key = new Key(1088, 960);
...
//        player.setLastPosition(player.collider().centerX(), player.collider().centerY());
    ...
    public void mapInit() {
        floorArr = Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor0");
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_down"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_down_up"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_left"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_left_down"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_left_up"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_leftx3"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_right"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_right_down"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_right_left"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_right_up"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_rightx3"));
        floorArr.addAll(Map.genFloor("/Map00X.bmp", "/Map00X.txt", "floor_wall_up"));


        spikeArr.addAll(Map.genSpike("/Map00X.bmp", "/Map00X.txt", "spike0"));
        stairArr = Map.genStair("/Map00X.bmp", "/Map00X.txt", "stair0_left");
        wallArr = Map.genWall("/Map00X.bmp", "/Map00X.txt", "brownwall");
    ...
    public void playerDead(){
        if (deadDelay.count() && player.getState() != Player.PlayerState.ALIVE) {
            deathCount++;
            SceneController.getInstance().change(new TransitionScene(1, playerNum));
        }
    }
    ...
    public void stair(){
        stairArr.forEach(g -> {
            if (g.isCollisionCenter(player) && player.keyCondition()) {
                ...
                SceneController.getInstance().change(new TowerScene(1,playerNum));
            }
        });
    }
    public void monster(){
